...
# OC terraform AWS Backup Module

OC Terraform module to create [AWS Backup](https://aws.amazon.com/backup/) plans.  AWS Backup is a fully managed backup service that makes it easy to centralize and automate the back up of data across AWS services (EBS volumes, RDS databases, DynamoDB tables, EFS file systems, and Storage Gateway volumes).
...
Check the oc-examples folder for the **simple plan**, **complete plan**, **simple plan using variables** and the **selection by tags plan** snippets.
...
module "aws_backup_example" {
  ...
  source = "git::https://github.cms.gov/OC-SHARED-RESOURCES/oc-terraform-aws-backup.git"
